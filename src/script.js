...
// Dot screen pass post processing
const dotScreenPass = new DotScreenPass()
// active or not
dotScreenPass.enabled = false
effectComposer.addPass(dotScreenPass)

// Glitch pass post processing
...
// RGB shift pass post processing
const rgbShiftPass = new ShaderPass(RGBShiftShader)
rgbShiftPass.enabled = false
effectComposer.addPass(rgbShiftPass)

// Gamma correction pass post processing
...
// DisplacementPass pass post processing 
...
displacementPass.material.uniforms.uNormalMap.value = new THREE.TextureLoader().load('/textures/interfaceNormalMap.png')
effectComposer.addPass(displacementPass)

// SMAA pass post processing
